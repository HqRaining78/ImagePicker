...
- (void)setupViews
{
    ...
    _backGroudView.backgroundColor = UIColorFromRGB(0x61cbf5);
    ...
    [_sendButton setTitle:@"完成"
                 forState:UIControlStateNormal];
    [_sendButton setTitleColor:UIColorFromRGB(0x61cbf5) forState:UIControlStateNormal];
    [_sendButton setTitleColor:UIColorFromRGB(0x61cbf5) forState:UIControlStateHighlighted];
    [_sendButton setTitleColor:UIColorFromRGB(0x61cbf5) forState:UIControlStateDisabled];
